...
VL_ATTR_COLD void VSingleCycleCPU___024root__trace_init_sub__TOP__0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+61,"start", false,-1);
    for (int i = 0; i < 32; ++i) {
    ...
    tracep->declBus(c+54,"pc_mux_out", false,-1, 31,0);
    ...
    tracep->declBit(c+94,"BranchOut", false,-1);
    ...
    tracep->declBus(c+95,"WriteData_mux1_out", false,-1, 31,0);
    tracep->declBus(c+96,"WriteData_mux2_out", false,-1, 31,0);
    tracep->declBus(c+55,"readData1", false,-1, 31,0);
    tracep->declBus(c+56,"readData2", false,-1, 31,0);
    tracep->declBus(c+97,"readData3", false,-1, 31,0);
    tracep->declBus(c+46,"imm", false,-1, 31,0);
    tracep->declBus(c+57,"alu_mux1_out", false,-1, 31,0);
    tracep->declBus(c+58,"alu_mux2_out", false,-1, 31,0);
    ...
    tracep->declBit(c+61,"rst", false,-1);
    tracep->declBit(c+39,"regWrite", false,-1);
    tracep->declBus(c+51,"readReg1", false,-1, 4,0);
    tracep->declBus(c+52,"readReg2", false,-1, 4,0);
...
VL_ATTR_COLD void VSingleCycleCPU___024root__trace_full_sub_0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+37,(vlSelf->SingleCycleCPU__DOT__immUse));
    bufp->fullBit(oldp+38,(vlSelf->SingleCycleCPU__DOT__memtoReg));
    bufp->fullBit(oldp+39,(vlSelf->SingleCycleCPU__DOT__regWrite));
    ...
    bufp->fullBit(oldp+43,(vlSelf->SingleCycleCPU__DOT__jump));
    bufp->fullBit(oldp+44,(vlSelf->SingleCycleCPU__DOT__pcUse));
    ...
    bufp->fullCData(oldp+51,(((0x80U <= vlSelf->SingleCycleCPU__DOT__pc_o)
    ...
    bufp->fullIData(oldp+54,(vlSelf->SingleCycleCPU__DOT__pc_mux_out),32);
    ...
    bufp->fullIData(oldp+57,(vlSelf->SingleCycleCPU__DOT__alu_mux1_out),32);
    bufp->fullIData(oldp+58,(vlSelf->SingleCycleCPU__DOT__alu_mux2_out),32);
    bufp->fullIData(oldp+59,(vlSelf->SingleCycleCPU__DOT__ALUOut),32);
    bufp->fullBit(oldp+60,(vlSelf->clk));
    bufp->fullBit(oldp+61,(vlSelf->start));
    bufp->fullIData(oldp+62,(vlSelf->r[0]),32);
    bufp->fullIData(oldp+63,(vlSelf->r[1]),32);
    bufp->fullIData(oldp+64,(vlSelf->r[2]),32);
    bufp->fullIData(oldp+65,(vlSelf->r[3]),32);
    bufp->fullIData(oldp+66,(vlSelf->r[4]),32);
    bufp->fullIData(oldp+67,(vlSelf->r[5]),32);
    bufp->fullIData(oldp+68,(vlSelf->r[6]),32);
    bufp->fullIData(oldp+69,(vlSelf->r[7]),32);
    bufp->fullIData(oldp+70,(vlSelf->r[8]),32);
    bufp->fullIData(oldp+71,(vlSelf->r[9]),32);
    bufp->fullIData(oldp+72,(vlSelf->r[10]),32);
    bufp->fullIData(oldp+73,(vlSelf->r[11]),32);
    bufp->fullIData(oldp+74,(vlSelf->r[12]),32);
    bufp->fullIData(oldp+75,(vlSelf->r[13]),32);
    bufp->fullIData(oldp+76,(vlSelf->r[14]),32);
    bufp->fullIData(oldp+77,(vlSelf->r[15]),32);
    bufp->fullIData(oldp+78,(vlSelf->r[16]),32);
    bufp->fullIData(oldp+79,(vlSelf->r[17]),32);
    bufp->fullIData(oldp+80,(vlSelf->r[18]),32);
    bufp->fullIData(oldp+81,(vlSelf->r[19]),32);
    bufp->fullIData(oldp+82,(vlSelf->r[20]),32);
    bufp->fullIData(oldp+83,(vlSelf->r[21]),32);
    bufp->fullIData(oldp+84,(vlSelf->r[22]),32);
    bufp->fullIData(oldp+85,(vlSelf->r[23]),32);
    bufp->fullIData(oldp+86,(vlSelf->r[24]),32);
    bufp->fullIData(oldp+87,(vlSelf->r[25]),32);
    bufp->fullIData(oldp+88,(vlSelf->r[26]),32);
    bufp->fullIData(oldp+89,(vlSelf->r[27]),32);
    bufp->fullIData(oldp+90,(vlSelf->r[28]),32);
    bufp->fullIData(oldp+91,(vlSelf->r[29]),32);
    bufp->fullIData(oldp+92,(vlSelf->r[30]),32);
    bufp->fullIData(oldp+93,(vlSelf->r[31]),32);
    bufp->fullBit(oldp+94,(((8U & (IData)(vlSelf->SingleCycleCPU__DOT__BranchCtl))
    ...
    bufp->fullIData(oldp+95,(vlSelf->SingleCycleCPU__DOT__WriteData_mux1_out),32);
    bufp->fullIData(oldp+96,(((IData)(vlSelf->SingleCycleCPU__DOT__jump)
                               ? ((IData)(4U) + vlSelf->SingleCycleCPU__DOT__pc_o)
                               : vlSelf->SingleCycleCPU__DOT__WriteData_mux1_out)),32);
    bufp->fullIData(oldp+97,(vlSelf->SingleCycleCPU__DOT__readData3),32);
    bufp->fullBit(oldp+98,(((((8U & (IData)(vlSelf->SingleCycleCPU__DOT__BranchCtl))
                               ? ((4U & (IData)(vlSelf->SingleCycleCPU__DOT__BranchCtl))
                                   ? ((~ ((IData)(vlSelf->SingleCycleCPU__DOT__BranchCtl) 
                                          >> 1U)) & 
                                      ((1U & (IData)(vlSelf->SingleCycleCPU__DOT__BranchCtl))
