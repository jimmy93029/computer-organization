                                                ...
                                                & (((IData)(vlSelf->PipelineCPU__DOT__Ex_RegRd) 
                                                   ...
                                                   | ((IData)(vlSelf->PipelineCPU__DOT__Ex_RegRd) 
                                                      ...
                                                      (0x1fU 
                                                       & (vlSelf->PipelineCPU__DOT__ID_instruction 
                                                          >> 0x14U))))));
    if (((~ (IData)(vlSelf->PipelineCPU__DOT____Vcellinp__m_HazardDetectUnit__Ex_jump_or_branch)) 
         & ((IData)(vlSelf->PipelineCPU__DOT__Ex_memRead) 
            & (((IData)(vlSelf->PipelineCPU__DOT__Ex_RegRd) 
                == (0x1fU & (vlSelf->PipelineCPU__DOT__ID_instruction 
                             >> 0xfU))) | ((IData)(vlSelf->PipelineCPU__DOT__Ex_RegRd) 
                                           == (0x1fU 
                                               & (vlSelf->PipelineCPU__DOT__ID_instruction 
                                                  >> 0x14U))))))) {
        vlSelf->PipelineCPU__DOT__IF_ID_freeze = 1U;
        vlSelf->PipelineCPU__DOT__IF_pc_mux = vlSelf->PipelineCPU__DOT__IF_pc;
    } else {
        vlSelf->PipelineCPU__DOT__IF_ID_freeze = 0U;
        vlSelf->PipelineCPU__DOT__IF_pc_mux = (((IData)(vlSelf->PipelineCPU__DOT____VdfgTmp_h13f1118f__0) 
                                                | (IData)(vlSelf->PipelineCPU__DOT__Ex_jump))
...
VL_ATTR_COLD void VPipelineCPU___024root___ctor_var_reset(VPipelineCPU___024root* vlSelf) {
    ...
    vlSelf->PipelineCPU__DOT__Mem_pc = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__Wb_pc = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__IF_pc_mux = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__ID_instruction = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__ID_BranchCtl = VL_RAND_RESET_I(4);
    vlSelf->PipelineCPU__DOT__Ex_BranchCtl = VL_RAND_RESET_I(4);
    vlSelf->PipelineCPU__DOT__ID_immUse = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__Ex_immUse = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__ID_memtoReg = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__Ex_memtoReg = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__Mem_memtoReg = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__Wb_memtoReg = VL_RAND_RESET_I(1);
    ...
    vlSelf->PipelineCPU__DOT__Mem_jump = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__Wb_jump = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__ID_pcUse = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__Ex_pcUse = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__ID_ALUOp = VL_RAND_RESET_I(2);
    vlSelf->PipelineCPU__DOT__Wb_writeData = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__Ex_readData1 = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__Ex_readData2 = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__Mem_rs2_Data = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__Mem_readData3 = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__Wb_readData3 = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__Ex_RegRs1 = VL_RAND_RESET_I(5);
    vlSelf->PipelineCPU__DOT__Ex_RegRs2 = VL_RAND_RESET_I(5);
    vlSelf->PipelineCPU__DOT__Ex_RegRd = VL_RAND_RESET_I(5);
    vlSelf->PipelineCPU__DOT__Mem_RegRd = VL_RAND_RESET_I(5);
    vlSelf->PipelineCPU__DOT__Wb_RegRd = VL_RAND_RESET_I(5);
    ...
    vlSelf->PipelineCPU__DOT__rs1_Data = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__rs2_Data = VL_RAND_RESET_I(32);
    ...
    vlSelf->PipelineCPU__DOT__ID_ALUCtl = VL_RAND_RESET_I(4);
    vlSelf->PipelineCPU__DOT__Ex_ALUCtl = VL_RAND_RESET_I(4);
    vlSelf->PipelineCPU__DOT__forwardA = VL_RAND_RESET_I(2);
    vlSelf->PipelineCPU__DOT__forwardB = VL_RAND_RESET_I(2);
    vlSelf->PipelineCPU__DOT__ID_Ex_flush = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__IF_ID_freeze = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT____Vcellinp__m_HazardDetectUnit__Ex_jump_or_branch = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT____VdfgTmp_h13f1118f__0 = 0;
    ...
    vlSelf->__Vdly__PipelineCPU__DOT__ID_instruction = VL_RAND_RESET_I(32);
